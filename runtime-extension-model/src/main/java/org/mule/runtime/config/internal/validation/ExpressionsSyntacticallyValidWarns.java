...
public class ExpressionsSyntacticallyValidWarns implements Validation {

  private final ExpressionLanguage expressionLanguage;

  public ExpressionsSyntacticallyValidWarns(ExpressionLanguage expressionLanguage) {
        ...
        .map(pmz -> getGroupAndParametersPairs(pmz)
            ...
            .flatMap(param -> {
              return expressionLanguage.validate(param.getValue().getLeft()).messages().stream()
                  .filter(msg -> msg.getSeverity().equals(WARNING))
